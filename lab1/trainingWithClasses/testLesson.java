...
public class testLesson {
	...
	public static void main(String[] args) {
		...
		Lesson oop = new Lesson("OOP", Days.TUE, new Time(14,30), Format.OFFLINE, new Duration(100), Type.Lecture);
		Lesson algo = new Lesson("ADS", Days.WED, new Time(13,30), Format.ONLINE, new Duration(100), Type.Lecture);
		Lesson db = new Lesson("DB", Days.TUE, new Time(14,30), Format.OFFLINE, new Duration(100), Type.Lecture);
