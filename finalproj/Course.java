...
public class Course implements Serializable {
    ...
    protected Vector<String> teachers;
    ...
    public Course(String courseName, Integer credits, String description, String courseId, Boolean isAvailable, Vector<String> teachers, Vector<Student> students, Vector<File> courseFiles, HashMap<Student,Mark> marks, Vector<String> prerequisite, Boolean isElective) {
    ...
    public Course(String courseName, int credits, String courseId, Teacher teacher, String description) {
        this.courseName = courseName;
        this.credits = credits;
        this.courseId = courseId;
    ...
    */
    public void removeCourseFile(String fileName, String courseId) {
        for (File file2 : courseFiles) {
            if(file2.getFileName().equals(fileName) && file2.getCourseName().equals(courseId)) {
